    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-green-50 flex flex-col items-center py-6 px-2 md:px-0">
      <div className="w-full max-w-5xl bg-white/90 rounded-3xl shadow-2xl p-2 sm:p-4 md:p-8 flex flex-col md:flex-row gap-6 md:gap-10 relative overflow-hidden">
        ...
        <form className="flex-1 space-y-6 min-w-0" onSubmit={handleSubmit}>
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-extrabold text-blue-900 mb-2 tracking-tight drop-shadow">
            Checkout
          </h1>
          <p className="text-gray-500 mb-6 text-sm sm:text-base">
            Complete your order and enjoy fast, secure delivery!
          </p>
          ...
          <div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-6">
              ...
              <label className="flex items-center gap-2 cursor-pointer">
                <input
                  ...
                  checked={form.paymentMethod === "easypaisa_jazzcash"}
                  onChange={handleChange}
            ...
            {/* Ye tab show hoga jab "EasyPaisa / JazzCash" select hoga */}
            {form.paymentMethod === "easypaisa_jazzcash" && (
              <div className="mt-3 p-3 bg-gray-50 border border-gray-200 rounded-lg text-sm text-gray-700 space-y-1">
                <div>
                  EasyPaisa: <strong>0326-9850071</strong>
                </div>
                <div>
                  JazzCash: <strong>0326-9850071</strong>
                </div>
              </div>
            )}
        ...
        <div className="flex-1 bg-gradient-to-br from-blue-100 to-green-100 rounded-2xl shadow-lg p-4 sm:p-6 md:p-8 flex flex-col gap-4 sm:gap-6 min-w-0 max-w-md mx-auto mt-8 md:mt-0">
          <h2 className="text-xl sm:text-2xl font-bold text-blue-800 mb-2 flex items-center gap-2">
            <svg width="28" height="28" fill="none" viewBox="0 0 24 24">
              ...
              />
              <circle cx="7" cy="21" r="2" stroke="#0ea5e9" strokeWidth="2" />
              <circle cx="17" cy="21" r="2" stroke="#0ea5e9" strokeWidth="2" />
            </svg>
            Order Summary
          </h2>
          <div className="divide-y divide-blue-200">
            {cart.items.map((item, i) => (
              ...
              >
                <Image
                  src={item.product.img || item.product.imageUrl}
                  alt={item.product.name}
                  width={40}
                  height={40}
                  className="rounded-lg shadow w-10 h-10 sm:w-14 sm:h-14"
                  unoptimized
                />
                ...
                <div className="font-bold text-blue-700 text-xs sm:text-base">
          ...
          <div className="mt-6 flex flex-col gap-2 items-center">
            {form.deliveryMethod === "regular" ? (
              <div className="flex flex-col items-center">
                <span className="text-blue-700 font-semibold mb-1 text-xs sm:text-base">
                  Regular Delivery
                </span>
                {DELIVERY_OPTIONS[0].svg}
                <span className="text-xs text-gray-500 mt-1">
                  Your order will arrive in 2-4 days by van.
                </span>
              </div>
            ) : (
              <div className="flex flex-col items-center">
                <span className="text-orange-600 font-semibold mb-1 text-xs sm:text-base">
                  Urgent Delivery
                </span>
