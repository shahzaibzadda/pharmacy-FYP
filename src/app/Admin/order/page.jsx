              ...
              {loading ? (
                ...
                paginatedOrders.map((order) => (
                  <>
                    <tr
                      key={order._id}
                      className="hover:bg-[#343148FF]/10 transition cursor-pointer"
                      onClick={() =>
                        setExpanded((e) => ({
                          ...e,
                          [order._id]: !e[order._id],
                        }))
                      }
                    >
                      ...
                      <td className="px-4 py-3">
                        <span
                          className={`px-2 py-1 rounded-full text-xs font-semibold ${order.isPaid ? "bg-green-100 text-green-800" : "bg-yellow-100 text-yellow-800"}`}
                        >
                      ...
                      <td className="px-4 py-3">
                        <span
                          className={`px-2 py-1 rounded-full text-xs font-semibold ${order.deliveryMethod === "urgent" ? "bg-red-100 text-red-700" : "bg-blue-100 text-blue-700"}`}
                        >
                      ...
                      <td className="px-4 py-3">
                        <span
                          className={`px-2 py-1 rounded-full text-xs font-semibold ${order.isDelivered ? "bg-green-100 text-green-800" : "bg-gray-100 text-gray-800"}`}
                        >
                      ...
                      <td className="px-4 py-3 space-y-1">
                        {!order.isDelivered && (
                          <button
                            ...
                            onClick={(e) => {
                              e.stopPropagation();
                              handleUpdate(order._id, "isDelivered");
                            }}
                          >
                            {updating[order._id]
                              ? "Updating..."
                                  ...
                                  >
                                    ...
                                    <div>
                                      ...
                                      <div className="text-xs text-gray-500">
                                        ...
                                        ×{" "}
                                        {currency(
                                          item.price?.$numberInt || item.price,
                                        )}
                                      </div>
                                    </div>
                                  </li>
